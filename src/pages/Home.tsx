        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              История, которая началась в глубине сибирской тайги
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <img 
                src="https://cdn.poehali.dev/projects/e5392123-9506-4d3a-a0b1-7bc7a59051cc/files/bd458bbb-6d12-4056-84e9-c5c0e7e4e6f7.jpg" 
                alt="Дед Саян - основатель компании"
                className="rounded-2xl shadow-2xl w-full object-cover"
              />
            </div>
            <div className="space-y-6">
              <h3 className="text-3xl font-bold">Дед Саян — хранитель тайги</h3>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Более 40 лет назад дед Саян начал собирать травы в сибирской тайге. 
                Знания о целебных свойствах растений передавались в его семье из поколения в поколение.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Сегодня наша компания продолжает традиции предков — мы собираем травы, 
                грибы и ягоды только в экологически чистых районах Сибири, далеко от цивилизации.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Каждый продукт проходит ручной отбор и сушится по старинным технологиям, 
                сохраняя максимум полезных свойств.
              </p>
            </div>
          </div>
          ...
          <div className="relative rounded-2xl overflow-hidden h-96 mb-16">
            <img 
              src="https://cdn.poehali.dev/projects/e5392123-9506-4d3a-a0b1-7bc7a59051cc/files/a4cf6c04-cb4d-451d-a8c2-f33b72d09e2b.jpg" 
              alt="Сибирская тайга"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent flex items-end">
              <div className="p-12 text-white">
                <h3 className="text-4xl font-bold mb-4">Наша тайга — наш дом</h3>
                <p className="text-xl max-w-3xl">
                  Мы собираем дары природы с уважением к лесу, заботясь о его сохранении для будущих поколений
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-8 bg-primary/5 rounded-xl">
              ...
              <h4 className="text-3xl font-bold mb-2 text-primary">40+</h4>
              <p className="text-muted-foreground text-lg">лет опыта сбора трав</p>
            </div>
            <div className="p-8 bg-secondary/5 rounded-xl">
              <div className="text-5xl mb-4">✅</div>
              <h4 className="text-3xl font-bold mb-2 text-secondary">100%</h4>
              <p className="text-muted-foreground text-lg">натуральные продукты</p>
            </div>
            <div className="p-8 bg-accent/5 rounded-xl">
              <div className="text-5xl mb-4">🏔️</div>
              <h4 className="text-3xl font-bold mb-2 text-accent">1000+</h4>
